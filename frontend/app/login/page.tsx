    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-950 px-4 py-12 text-slate-100">
      ...
      <div className="glass-panel w-full max-w-md rounded-2xl p-8 shadow-2xl border border-white/10">
        ...
        <div className="text-center">
          ...
          <h2 className="mt-5 text-xl font-bold text-white">Sign In to Your Account</h2>
          <p className="mt-1 text-xs text-slate-400">Access real-time documents and collaboration rooms</p>
        </div>
